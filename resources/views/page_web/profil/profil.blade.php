                        ...
                        <h2 class="account__title">Edit Profil</h2>
                            ...
                            <div class="account__input-field text-center mb-4">
                                <div class="position-relative d-inline-block mb-3">
                                             ...
                                             id="previewImage"
                                             style="width: 150px; height: 150px; object-fit: cover; aspect-ratio: 1/1; border: 4px solid var(--color-primary);">
                                                @else
            ...
            reader.onload = function(e) {
                ...
                if (preview) {
                    ...
                    img.src = e.target.result;
                        ...
                        img.style.cssText = 'width: 150px; height: 150px; object-fit: cover; aspect-ratio: 1/1; border: 4px solid var(--color-primary);';
                        img.id = 'previewImage';
