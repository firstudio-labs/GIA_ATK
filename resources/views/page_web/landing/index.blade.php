        ...
        <div class="swiper hero-slider">
            <div class="swiper-wrapper">
                <div class="swiper-slide">
                    <div class="hero-3">
                        <div class="hero-bg bg-cover"
                            style="background-image: url('{{ asset('web') }}/assets/img/hero/hero-bg-1.jpg');"></div>
                        <div class="container">
                ...
                <div class="swiper-slide">
                    <div class="hero-3">
                        <div class="hero-bg bg-cover"
                            style="background-image: url('{{ asset('web') }}/assets/img/hero/hero-bg-2.jpg');"></div>
                        <div class="container">
                            <div class="row g-4 align-items-center">
                                <div class="col-lg-6">
                                    <div class="hero-content">
            ...
            <div class="swiper catagory-product-slider">
                <div class="swiper-wrapper">
                    @forelse($produkTerbaru as $produk)
                        <div class="swiper-slide">
                            <div class="shop-catagories-item position-relative">
                                <div class="thumb d-flex justify-content-center align-items-center"
                                    style="position:relative;">
                                    @php
                                        $gambar =
                                            is_array($produk->gambar_produk) && count($produk->gambar_produk) > 0
                                    ...
                                    <span class="badge bg-danger position-absolute"
                                        style="top:6px; left:6px; z-index:2; font-size: 0.8rem;">NEW</span>
                                </div>
                                <div class="content">
                                    <h3><a href="{{ route('shop.detail', $produk->slug) }}">{{ $produk->judul }}</a></h3>
                                    <p>
                                        @if ($produk->diskon > 0)
                                            ...
                                            <span class="text-primary fw-bold">Rp
                                                {{ number_format($produk->harga - ($produk->harga * $produk->diskon) / 100, 0, ',', '.') }}</span>
                                        @else
                                            <span class="text-primary fw-bold">Rp
                                                {{ number_format($produk->harga, 0, ',', '.') }}</span>
                                        @endif
                    ...
                    @empty
                        <div class="swiper-slide">
                            <div class="shop-catagories-item">
                                <div class="thumb d-flex justify-content-center align-items-center"
                                    style="position:relative;">
                                    <img src="{{ asset('web') }}/assets/img/catagories/10.png" alt="img"
                                        style="width:90px; height:90px; object-fit:cover; border-radius:8px;">
                                    <span class="badge bg-danger position-absolute"
                                        style="top:6px; left:6px; z-index:2; font-size: 0.8rem;">NEW</span>
                                </div>
                        ...
                        <div class="about-content">
                            ...
                            <p class="mt-3 mt-md-0 wow fadeInUp" data-wow-delay=".5s">
                                ...
                                @else
                                    ...
                                    Dengan pengalaman bertahun-tahun, kami siap membantu mewujudkan produk cetak impian
                                    Anda.
                                @endif
                            </p>
                            <div class="icon-box-items">
                                <div class="icon-items wow fadeInUp" data-wow-delay=".3s">
                                    ...
                                    <div class="content">
                                        ...
                                        <p>
                                            Dapatkan konsultasi gratis untuk kebutuhan percetakan Anda. Tim kami siap
                            ...
                            <div class="about-author">
                                @if (isset($ownerWhatsapp) && $ownerWhatsapp->no_wa)
                                    ...
                                    @endphp
                                    <a href="https://wa.me/{{ $no_wa_clean }}" target="_blank"
                                        class="theme-btn wow fadeInUp" data-wow-delay=".3s"
                                        style="background-color:#25D366; border: none; color:#fff;">
                                        <i class="fab fa-whatsapp"></i> Hubungi Kami
                                    </a>
                                @else
                                    <a href="{{ route('about') }}" class="theme-btn wow fadeInUp"
                                        data-wow-delay=".3s">LEBIH LANJUT</a>
                                @endif
                                <div class="author-image wow fadeInUp d-flex align-items-center gap-3"
                                    data-wow-delay=".5s">
                                    <div class="author-logo"
                                        style="width:54px; height:54px; overflow:hidden; border-radius:50%; flex-shrink:0; border: 1.5px solid #eee; background: #fff;">
                                        ...
                                        @else
                                            ...
                                            @endphp
                                            <img src="{{ $logoDefault }}" alt="author-img"
                                                style="width: 100%; height: 100%; object-fit: contain; display:block;">
                                        @endif
                                    </div>
                                    <div class="content ps-1">
                                        <span class="mb-2" style="display: block; font-size: 0.95em;">Hubungi Ahli
                                            Kami</span>
                                        @if (isset($profil) && $ownerWhatsapp->no_wa)
                                            <h4 style="font-size:1.2em; margin:0;"><a
                                                    href="https://wa.me/{{ preg_replace('/[^0-9]/', '', $ownerWhatsapp->no_wa) }}"
                                                    target="_blank">{{ $ownerWhatsapp->no_wa }}</a></h4>
                                    ...
                                    <div class="col-lg-6">
                                        <div class="thumb-image-1">
                                            @if (isset($profil) && $profil->gambar)
                                                <img src="{{ asset('profil/gambar/' . $profil->gambar) }}"
                                                    alt="{{ $profil->nama_perusahaan ?? 'img' }}">
                                            @else
                                                <img src="{{ asset('web') }}/assets/img/about/about-1.jpg"
                                                    alt="img">
                                            @endif
                                        </div>
                    ...
                    <ul class="nav">
                        @foreach ($produkPerKategori as $index => $item)
                            <li class="nav-item wow fadeInUp" data-wow-delay="{{ $index * 0.2 + 0.2 }}s">
                                <a href="#kategori-{{ $item['kategori']->id }}" data-bs-toggle="tab"
                        ...
                        <div id="kategori-{{ $item['kategori']->id }}"
                                        ...
                                        <div class="shop-items style-2">
                                            <div class="shop-image">
                                                ...
                                                <ul class="product-icon d-grid justify-content-center align-items-center">
                                                    <li>
                                                        <a href="{{ route('shop.detail', $produk->slug) }}"><i
                                            ...
                                            <div class="shop-content">
                                                <h5><a
                                                        href="{{ route('shop.detail', $produk->slug) }}">{{ $produk->judul }}</a>
                                                </h5>
                                                <ul class="price-list">
                                                    @if ($produk->diskon > 0)
                                                        @php
                                                        ...
                                                        @endphp
                                                        <li>Rp {{ number_format($hargaDiskon, 0, ',', '.') }} <del>Rp
                                                                {{ number_format($produk->harga, 0, ',', '.') }}</del></li>
                                                    @else
                            ...
                            @if ($item['produks']->count() > 0)
                                <div class="text-center mt-4">
                                    <a href="{{ route('shop', ['kategori' => $item['kategori']->id]) }}"
                                        class="theme-btn">
