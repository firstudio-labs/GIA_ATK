                    ...
                    <div class="col-xl-6 col-lg-6">
                        <div class="about__img">
                            @if(isset($profil) && $profil->gambar)
                                <img src="{{ asset('profil/gambar/' . $profil->gambar) }}" alt="{{ $profil->nama_perusahaan ?? 'Tentang Kami' }}">
                            @else
                                <img src="{{ asset('web') }}/assets/img/about/img_01.jpg" alt="">
                            @endif
                        </div>
                    </div>
                    <div class="col-xl-6 col-lg-6">
                ...
                <div class="row g-0 align-items-center flex-row-reverse md-mt-30">
                    <div class="col-xl-6 col-lg-6">
                        <div class="about__img">
                            ...
                            @else
                                <img src="{{ asset('web') }}/assets/img/about/img_03.jpg" alt="">
                            @endif
                        </div>
                    </div>
                    <div class="col-xl-6 col-lg-6">
                            ...
                            <div class="about__video mt-35 ul_li">
                                <div class="about__video-img pos-rel">
                                    @if(isset($profil) && $profil->gambar)
                                        <img src="{{ asset('profil/gambar/' . $profil->gambar) }}" alt="{{ $profil->nama_perusahaan ?? 'Tentang Kami' }}">
                                    @else
                                        <img src="{{ asset('web') }}/assets/img/about/img_02.jpg" alt="">
                                    @endif
                                </div>
