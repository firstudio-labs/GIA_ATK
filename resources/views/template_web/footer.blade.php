        ...
        <div class="container">
                ...
                <div class="row mt-none-40">
                    <div class="footer__widget col-lg-3 col-md-6 mt-40">
                        <div class="footer__logo mb-20">
                            <a href="index.html"><img src="{{ asset('web') }}/assets/img/logo/logo.svg" alt=""></a>
                        </div>
                        ...
                        <div class="apps-img mt-15 ul_li">
                            <div class="app mt-15">
                                <a href="#!"><img src="{{ asset('web') }}/assets/img/icon/google_play.png" alt=""></a>
                            </div>
                            <div class="app mt-15">
                                <a href="#!"><img src="{{ asset('web') }}/assets/img/icon/app_store.png" alt=""></a>
                            </div>
                        </div>
                    </div>
                    <div class="footer__widget col-lg-3 col-md-6 mt-40">
            ...
            <div class="footer__bottom ul_li_center">
                ...
                <div class="payment_method mt-15">
                    <img src="{{ asset('web') }}/assets/img/bg/payment_method.png" alt="">
                </div>
            </div>
        </div>
    </footer>
