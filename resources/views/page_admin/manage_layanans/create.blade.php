          ...
          <div class="row align-items-center">
            <div class="col-md-12">
              <ul class="breadcrumb">
                ...
                <li class="breadcrumb-item" aria-current="page">Form Tambah Data Layanan</li>
              </ul>
            </div>
            <div class="col-md-12">
              <div class="page-header-title">
                <h2 class="mb-0">Form Tambah Data Layanan</h2>
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="col-sm-10">
          ...
          <div class="card">
            <div class="card-header">
              <h5>Form Tambah Data Layanan</h5>
            </div>
            <div class="card-body">
              <form action="{{ route('manage-layanan.store') }}" method="POST" id="layananForm" enctype="multipart/form-data">
                @csrf
                <div class="row">
                  <div class="col-md-12">
                    <div class="form-group">
                      <label class="form-label">Judul Layanan <span class="text-danger">*</span></label>
                      <input type="text" name="judul_layanan" class="form-control @error('judul_layanan') is-invalid @enderror" value="{{ old('judul_layanan') }}" placeholder="Masukkan judul layanan" required>
                      @error('judul_layanan')
                ...
                <div class="row">
                  <div class="col-md-12">
                    <div class="form-group">
                      ...
                      <textarea name="deskripsi_layanan" class="form-control @error('deskripsi_layanan') is-invalid @enderror" rows="5" placeholder="Masukkan deskripsi layanan" required>{{ old('deskripsi_layanan') }}</textarea>
                ...
                <div class="row">
                  <div class="col-md-12">
                    <div class="form-group">
                      ...
                      <div id="faqContainer">
                        <!-- FAQ rows will be added here dynamically -->
                      </div>
                    </div>
                  </div>
                </div>
