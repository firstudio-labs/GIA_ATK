        ...
        <div class="col-lg-12">
          ...
          <div class="card">
            ...
            <div class="card-body">
              ...
              @endif
              <form action="{{ route('profil-perusahaan.store') }}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="row">
                  <!-- Kolom Kiri -->
                  <div class="col-md-6">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" name="tiktok_perusahaan" class="form-control @error('tiktok_perusahaan') is-invalid @enderror" value="{{ old('tiktok_perusahaan') }}" placeholder="Masukkan username TikTok">
