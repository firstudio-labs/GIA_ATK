          ...
          <div class="row align-items-center">
            <div class="col-md-12">
              <ul class="breadcrumb">
                ...
                <li class="breadcrumb-item" aria-current="page">Form Tambah Data Owner WhatsApp</li>
              </ul>
            </div>
            <div class="col-md-12">
              <div class="page-header-title">
                <h2 class="mb-0">Form Tambah Data Owner WhatsApp</h2>
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="col-sm-10">
          ...
          <div class="card">
            <div class="card-header">
              <h5>Form Tambah Data Owner WhatsApp</h5>
            </div>
            <div class="card-body">
              <form action="{{ route('owner-whatsapp.store') }}" method="POST" id="ownerWhatsappForm">
                @csrf
                <div class="row">
                  <div class="col-md-12">
                    <div class="form-group">
                      ...
                      <div class="input-group">
                        ...
                        <input type="text" name="no_wa" class="form-control @error('no_wa') is-invalid @enderror" value="{{ old('no_wa') }}" placeholder="Masukkan nomor WhatsApp (contoh: 6281234567890)" required>
                      </div>
                ...
                <div class="row">
                  <div class="col-md-12">
                    <div class="form-group">
                      ...
                      <textarea name="template_pesan" class="form-control @error('template_pesan') is-invalid @enderror" rows="8" placeholder="Masukkan template pesan WhatsApp" required>{{ old('template_pesan') }}</textarea>
