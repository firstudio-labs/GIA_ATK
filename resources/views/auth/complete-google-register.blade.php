...
<head>
  ...
  <title>Lengkapi Pendaftaran | {{ $profil->nama_perusahaan ?? 'StarterKit-v2' }}</title>
  ...
  @endif  <link rel="stylesheet" href="https://fonts.googleapis.com/css2?family=Public+Sans:wght@300;400;500;600;700&display=swap" id="main-font-link">
